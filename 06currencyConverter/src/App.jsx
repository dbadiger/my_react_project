...
function App() {
  ...
  return (
    ...
    style={{backgroundImage:`url('https://images.pexels.com/photos/318820/pexels-photo-318820.jpeg?auto=compress&cs=tinysrgb&w=300')`}}
    >
      <h1 className='text-3xl font-bold underline'>Currency Conveter</h1>
